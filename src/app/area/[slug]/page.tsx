...
const AREAS: Record<string, AreaData> = {
  london: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 77, weight: 20, summary: "IMD decile 8/10 (low deprivation). Ranked 24,862 of 32,844 LSOAs (76th percentile). LSOA: Westminster 018C." },
  ...
  cardiff: {
    ...
    summary:
      "Cardiff City Centre scores 68/100 overall. Strong transport connectivity with 6 stations (including Cathays and Cardiff Bay) and 41 bus stops. 1,064 amenities including 55 schools and 323 food/drink venues. Crime is elevated at 3,683 incidents over 3 months, with violent crime at 33%. Zero flood risk zones and 567 parks/green spaces give it a near-perfect environment score of 95.",
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 50, weight: 20, summary: "IMD deprivation data unavailable (Wales, outside England coverage). Score defaults to 50/100." },
      { label: "Environment & Quality", score: 95, weight: 20, summary: "No flood risk zones within 3km. No active warnings. 567 parks/green spaces nearby." },
    ],
    lockedSections: ["Safety & Crime Analysis", "Transport Links Analysis", "Amenities & Services Analysis", "Demographics & Economy Analysis", "Environment & Quality Analysis"],
    lockedRecommendations: 4,
    intents: [
  ...
  liverpool: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 59, weight: 20, summary: "IMD decile 6/10 (moderate deprivation). Ranked 18,895 of 32,844 LSOAs (58th percentile). LSOA: Liverpool 061C." },
  ...
  glasgow: {
    ...
    summary:
      "Glasgow City Centre scores 73/100 overall. Excellent amenities with 1,276 venues including 560 food/drink outlets and 544 parks/leisure spaces. 15 rail stations and 48 bus stops provide strong connectivity. Zero flood risk zones and abundant green space give it a near-perfect environment score. Crime and IMD data are unavailable (Scotland falls outside Police.uk and England-only IMD coverage), defaulting those dimensions to 50.",
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 50, weight: 20, summary: "Deprivation data unavailable (Scotland, outside England IMD coverage). Score defaults to 50/100." },
      { label: "Environment & Quality", score: 95, weight: 20, summary: "No flood risk zones within 3km. No active warnings. 544 parks/green spaces nearby." },
    ],
    lockedSections: ["Safety & Crime Analysis", "Transport Links Analysis", "Amenities & Services Analysis", "Demographics & Economy Analysis", "Environment & Quality Analysis"],
    lockedRecommendations: 4,
    intents: [
      { label: "Moving", score: 71, slug: "moving" },
      { label: "Business", score: 59, slug: "business" },
      { label: "Investing", score: 60, slug: "investing" },
      { label: "Research", score: 73, slug: "research" },
    ],
    dataSources: ["OpenStreetMap", "Environment Agency", "Postcodes.io"],
  },
  belfast: {
  ...
  edinburgh: {
    ...
    lockedRecommendations: 4,
    intents: [
      { label: "Moving", score: 69, slug: "moving" },
      { label: "Business", score: 58, slug: "business" },
      { label: "Investing", score: 58, slug: "investing" },
  ...
  birmingham: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 32, weight: 20, summary: "IMD decile 3/10 (high deprivation). Ranked 9,525 of 32,844 LSOAs (29th percentile). LSOA: Birmingham 138A." },
  ...
  leeds: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 50, weight: 20, summary: "IMD decile 5/10 (moderate deprivation). Ranked 14,222 of 32,844 LSOAs (43rd percentile). LSOA: Leeds 111B." },
  ...
  sheffield: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 32, weight: 20, summary: "IMD decile 3/10 (high deprivation). Ranked 8,740 of 32,844 LSOAs (27th percentile). LSOA: Sheffield 075G." },
  ...
  nottingham: {
    ...
    dimensions: [
      ...
      { label: "Demographics & Economy", score: 86, weight: 20, summary: "IMD decile 9/10 (low deprivation). Ranked 27,218 of 32,844 LSOAs (83rd percentile). LSOA: Nottingham 028E." },
